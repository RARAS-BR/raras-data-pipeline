...
@flow(name='prospectivo_2023_flow',
      log_prints=True)
def run_flow():
    current_time: str = datetime.now().strftime('%d-%m')
    project_name = 'prospectivo_2023'
    raw_layer_db_name = 'prospectivo23-raw-layer'
    cleaned_layer_db_name = 'prospectivo23-cleaned-layer'
    instructions_folder = 'flows/prospectivo23/instructions'
    ...
    preprocessing_pipeline(
        ...
        token_name='token-prospectivo-2023',
